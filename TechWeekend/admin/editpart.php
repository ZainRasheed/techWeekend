...
{
 $id = $_GET['edit'];
 $res= mysqli_query($db,"SELECT * FROM mix WHERE sid='$id' and type='partners'");
 $row= mysqli_fetch_assoc($res);
    ...
    function GetImageExtension($imagetype)
      ...
      {
         $sql = "UPDATE mix SET imgpath='$newfileimg',name='$newname',contact='$newcontact',email='$newemail',link='$newlink',type='partners' WHERE sid='$id'";
      ...
      else // no image uploaded
      {
         // save data, but no change the image column in MYSQL, so it will stay the same value
          $sql =  "UPDATE mix SET name='$newname',contact='$newcontact',email='$newemail',link='$newlink',type='partners' WHERE sid='$id'";
      }
    ...
    <div class="col-sm-3 sidenav" style="background:#86C232;" >
      <form action="editpart.php" method="post" enctype="multipart/form-data">
        <div class="form-group">
          <label for="banner">Partner:</label>
          <?php $imageURL = 'img/partners/'.$row['imgpath'];?>
